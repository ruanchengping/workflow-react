...
class EditFlowModal extends React.Component{
	showSaveConfirm = () =>{
  ...
  componentDidMount = () =>{
    // console.log(this.props.flowRecord);
    let flowRecord = this.props.flowRecord;
    this.props.form.setFieldsValue({
      id:flowRecord.id,
      status: flowRecord.status,
      expandPeriod: flowRecord.expandPeriod,
      flow: flowRecord.flow,
      createTime: flowRecord.createTime==''?null:moment(flowRecord.createTime, dateFormat),
      creator:flowRecord.creator,
      endTime: flowRecord.endTime==''?null:moment(flowRecord.endTime, dateFormat),
      model: flowRecord.model,
      documentNum: flowRecord.documentNum,
...
EditFlowModal.contextTypes = {
  store: React.PropTypes.object
};
const mapStateToProps = (state, ownProps) => ({
  flowModel: state.flowModel,
});
export default connect(mapStateToProps)(Form.create()(EditFlowModal));