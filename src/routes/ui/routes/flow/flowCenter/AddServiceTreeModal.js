...
class AddServiceTreeModal extends React.Component{
	showSaveConfirm = () =>{
...
AddServiceTreeModal.contextTypes = {
  store: React.PropTypes.object
};
const mapStateToProps = (state, ownProps) => ({
  flowModel: state.flowModel,
});
export default connect(mapStateToProps)(Form.create()(AddServiceTreeModal));
